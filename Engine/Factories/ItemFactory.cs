...
namespace Engine.Factories
{
    public static class ItemFactory
    {
        ...
        static ItemFactory()
        {
            ...
            _standardGameItems.Add(new Weapon(1003, "The C#", 4500, 16, 32, 95, 30));
            _standardGameItems.Add(new Weapon(1011, "The Java-lin", 1200, 8, 32, 65, 10, "Pierce"));
            _standardGameItems.Add(new Potion(2001, "Health Potion", 10, "+50 HP"));
            _standardGameItems.Add(new GameItem(7001, "Pytorch", 10000));
