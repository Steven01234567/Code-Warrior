...
namespace Engine.Factories
{
    public static class ItemFactory
    {
        ...
        static ItemFactory()
        {
            _standardGameItems.Add(new Weapon(1001, "The C", 0, 0, 16));
            _standardGameItems.Add(new Weapon(1002, "The C++", 50, 8, 16));
            _standardGameItems.Add(new Weapon(1003, "The C#", 200, 32, 128));
            _standardGameItems.Add(new Weapon(1011, "Java-lin", 100, 0, 100));
            _standardGameItems.Add(new GameItem(2001, "Health Potion", 10));
