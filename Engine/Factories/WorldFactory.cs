...
namespace Engine.Factories
{
    internal static class WorldFactory
    {
        internal static World CreateWorld()
        {
            ...
            newWorld.AddLocation(-1, 0, "Ashembly Risky the Fifth, the Alchemist", "Try my potions...for a fair price hohoho...", "/Engine;component/Images/Locations/__NOT_MADE_YET__");
