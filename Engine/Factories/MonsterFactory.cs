...
namespace Engine.Factories
{
    public static class MonsterFactory
    {
        public static Monster GetMonster(int monsterID)
        {
            ...
            {
                case 101:
                    Monster mip = new Monster("Mip", "Mip.png", 5, 5, 1, 1, 5, 1);
                ...
                case 201:
                    Monster node = new Monster("Node", "Node.png", 8, 8, 2, 2, 8, 2);
                ...
                case 202:
                    Monster tree = new Monster("Tree", "Tree.png", 64, 64, 3, 3, 64, 8);
                ...
                case 301:
                    Monster python = new Monster("Python", "Python.png", 200, 200, 4, 4, 100, 50);
